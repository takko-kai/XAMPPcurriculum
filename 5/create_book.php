...
<body>
    ...
    <form action="" method="post">
        ...
        <h4>在庫数</h4><br>
        <input placeholder="選択してください" type="number" name="stock" min="0" max="100" style="width: 200px; height: 30px; margin-top: 0;">
        <br>
        <input class="newbook-button" type="submit" value="登録" name="post">
    </form>
</body>
</html>