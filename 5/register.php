...
<body>
    ...
    <form action="register.php" method="post">
        ...
        <input placeholder="パスワード" type="password" name="password" id="password" style="width: 300px; height: 30px; ">
        <br>
        <input class="register-button" type="submit" value="新規登録" name="register" id="register">
